...
handle_cast({trade_resources, {ReplyToken, RemoteResources}}, State) ->
    ...
    #state{
        local_resources = LocalResources, target_resource_types = TargetTypes, resources = Resources
    } = State,
...
handle_cast(
    {add_local_resource, {Type, Resource}}, #state{local_resources = LocalResources} = State
) ->
